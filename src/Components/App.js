  ...
  if (width > breakpoint) {
    ...
    return (
      ...
      <div id='MobileNotSupported'>
        ...
        <p>We are working hard to make our webpage better for you. Please bear with us as we optimize our site for different devices and screen sizes. Thank you for your patience and understanding. </p>
        <p>You can instead view our figma prototypes</p>
